...
class Stock():
    ...
    def set_profit_loss(self):
        URLPE = "https://api.iextrading.com/1.0/stock/tsla/financials"
    ...
    def set_moving_avg(self):
        RL = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=" + symbol "&apikey=WRV0ICYRFLQOX96V"
        ...
        print "the 10 day total"
        print tenDayTotal
        print "the 10 day moving average"
        print tenDayTotal / 10
        tenDayAvg = tenDayTotal / 10


        fiveDayOldPrice = float(data["Time Series (Daily)"][dates[4]]["4. close"])
        print "5 day old price is", fiveDayOldPrice
        print "the current price is", currnetPrice
